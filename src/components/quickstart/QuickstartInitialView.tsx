      ...
      <div className="flex gap-10">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <p className="text-sm text-neutral-400 leading-relaxed mb-6">
            Internal production tool for El Kiosk. Load a client and a subscription tier to auto-inject Brand DNA into the workflow and generate ready-to-publish social media assets.
          </p>
