    ...
    >
      ...
      {isDragOver && (
        <div className="absolute inset-0 bg-blue-500/10 z-50 pointer-events-none flex items-center justify-center">
          <div className="bg-[var(--c-node-bg)] border border-[var(--c-border)] rounded-lg px-6 py-4 shadow-xl">
      ...
      {isSplitting && (
        <div className="absolute inset-0 bg-black/50 z-50 flex items-center justify-center">
          <div className="bg-[var(--c-node-bg)] border border-[var(--c-border)] rounded-lg px-6 py-4 shadow-xl flex items-center gap-3">
            <div className="w-5 h-5 border-2 border-blue-500 border-t-transparent rounded-full animate-spin" />
            <p className="text-[var(--c-text)] text-sm font-medium">Splitting image grid...</p>
          </div>
        </div>
      )}
      ...
      >
        ...
        <Background color="var(--c-dot-primary)" gap={20} size={1} />
        <Controls className="!bg-[var(--c-controls-bg)] !border-[var(--c-controls-border)] !rounded-lg !shadow-lg [&>button]:!bg-[var(--c-controls-bg)] [&>button]:!border-[var(--c-controls-border)] [&>button]:![&_svg]:fill-[var(--c-controls-icon)] [&>button:hover]:!bg-[var(--c-controls-btn-hover)] [&>button:hover]:![&_svg]:fill-[var(--c-text)]" />
        <MiniMap
          className="!bg-[var(--c-controls-bg)] !border-[var(--c-controls-border)] !rounded-lg !shadow-lg"
          maskColor="var(--c-minimap-mask)"
          pannable
          zoomable
          nodeColor={(node) => {
            switch (node.type) {
          ...
          {allNodes.map((node) => {
            ...
            const browseAction = showBrowse ? (
              <button
                ...
                className="nodrag nopan text-[10px] py-0.5 px-1.5 bg-[var(--c-bg-elevated)] hover:bg-[var(--c-bg-hover)] border border-[var(--c-border)] rounded text-[var(--c-text-secondary)] transition-colors"
              >
                Browse
              </button>
            ) : undefined;
              ...
              <button
                ...
                className={`nodrag nopan text-[10px] py-0.5 px-1.5 rounded transition-colors ${
                  isOptional
                    ...
                    : "bg-[var(--c-bg-elevated)] hover:bg-[var(--c-bg-hover)] border border-[var(--c-border)] text-[var(--c-text-tertiary)]"
                }`}
